...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.find_order = channel.unary_unary(
                ...
                request_serializer=order__pb2.Identifier.SerializeToString,
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'find_order': grpc.unary_unary_rpc_method_handler(
                    servicer.find_order,
                    request_deserializer=order__pb2.Identifier.FromString,
...
class OrderService(object):
    ...
    def find_order(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/OrderService/find_order',
            order__pb2.Identifier.SerializeToString,
